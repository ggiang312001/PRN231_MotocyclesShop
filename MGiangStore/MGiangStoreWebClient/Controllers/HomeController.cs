...
using MGiangStoreWebClient.Models;
...
namespace MGiangStoreWebClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        private MGiangStoreContext context;
        private readonly HttpClient client = null;
        private readonly IConfiguration configuration;
        private string ApiPort = "";
        private readonly IWebHostEnvironment _env;

        public HomeController(ILogger<HomeController> logger, IConfiguration configuration, MGiangStoreContext context, IWebHostEnvironment env)
        {
            _logger = logger;
